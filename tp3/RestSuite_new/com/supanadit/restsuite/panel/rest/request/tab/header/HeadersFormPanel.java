...
public class HeadersFormPanel extends JScrollPane {
    ...
    public void addFormInput(HeadersFormInputPanel headersFormInputPanel) {
        analyse.Analyse.printMe("HeadersFormPanel","HeadersFormPanel");
    ...
    public void addFormInput(CollectionHeaderEntity collectionHeaderEntity) {
        analyse.Analyse.printMe("HeadersFormPanel","HeadersFormPanel");
        analyse.Analyse.printMe("CollectionHeaderEntity","HeadersFormPanel");
        analyse.Analyse.printMe("HeadersFormInputPanel","HeadersFormPanel");
        analyse.Analyse.printMe("CollectionHeaderEntity","HeadersFormPanel");
        analyse.Analyse.printMe("CollectionHeaderEntity","HeadersFormPanel");
        // Get Key
