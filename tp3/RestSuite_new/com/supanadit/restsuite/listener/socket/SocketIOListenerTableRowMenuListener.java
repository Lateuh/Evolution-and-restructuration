...
public class SocketIOListenerTableRowMenuListener extends MouseAdapter {
    ...
    public void mousePressed(MouseEvent e) {
        analyse.Analyse.printMe("SocketIOListenerTableRowMenuListener","SocketIOListenerTableRowMenuListener");
        if (e.isPopupTrigger())
            doPop(e);
    ...
    private void doPop(MouseEvent e) {
        analyse.Analyse.printMe("SocketIOListenerMouseTableRowMenu","SocketIOListenerTableRowMenuListener");
